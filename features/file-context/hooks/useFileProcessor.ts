...
export const useFileProcessor = () => {
    ...
    const processImage = useCallback(async (file: FileContext): Promise<FileContext> => {
        ...
        try {
            ...
            const mockText =
                'This is mock text extracted from the image using OCR. In production, this would be the actual text detected in the image.';
    ...
    const processPDF = useCallback(async (file: FileContext): Promise<FileContext> => {
        ...
        try {
            ...
            await new Promise((resolve) => setTimeout(resolve, 2000));
            const mockText =
                'This is mock text extracted from the PDF document. Page 1 contains important information about English grammar.';
    ...
    const processAudio = useCallback(async (file: FileContext): Promise<FileContext> => {
        ...
        try {
            ...
            const mockText =
                'This is a mock transcription of the audio file. The speaker is discussing English pronunciation and vocabulary.';
    ...
    const processFile = useCallback(
        async (file: FileContext): Promise<FileContext> => {
            switch (file.type) {
                case 'image':
