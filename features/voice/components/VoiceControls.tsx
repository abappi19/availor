    ...
    <View className="flex-row items-center justify-center p-4 bg-white border-b border-gray-200">
      ...
      >
        <Ionicons
          name="mic"
          size={20}
          color={sttEnabled ? 'white' : '#666'}
        />
        <Text className={`ml-2 font-medium ${sttEnabled ? 'text-white' : 'text-gray-700'}`}>
          Voice Input
        </Text>
      </TouchableOpacity>
      ...
      >
        <Ionicons
          name="volume-high"
          size={20}
          color={ttsEnabled ? 'white' : '#666'}
        />
        <Text className={`ml-2 font-medium ${ttsEnabled ? 'text-white' : 'text-gray-700'}`}>
          Voice Output
        </Text>
      </TouchableOpacity>
    </View>
