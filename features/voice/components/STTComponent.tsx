...
export const STTComponent: React.FC<STTComponentProps> = ({ onTranscription, onError }) => {
    ...
    return (
        <View className="items-center p-4">
            {isProcessing ? (
                ...
                <TouchableOpacity onPress={isRecording ? stopRecording : startRecording} className="items-center">
                    <AnimatedView
                        style={[pulseStyle]}
