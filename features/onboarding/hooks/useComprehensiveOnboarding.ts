  ...
  const completeOnboarding = useCallback(async () => {
    ...
    try {
      ...
      await aiPersonalizationService.saveSettings({
        ...
        vocabularyLevel: onboardingData.englishLevel! >= 'B2' ? 'advanced' : onboardingData.englishLevel! >= 'B1' ? 'intermediate' : 'simple',
        sentenceComplexity: onboardingData.englishLevel! >= 'B2' ? 'complex' : onboardingData.englishLevel! >= 'B1' ? 'moderate' : 'simple',
