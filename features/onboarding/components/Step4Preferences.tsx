...
import type { CorrectionFrequency, LearningPace, TeachingStyle } from '@/services/storage/aiPersonalization';
        ...
        <SafeAreaView className="flex-1 bg-white">
            <ScrollView className="flex-1" contentContainerStyle={{ padding: 24 }}>
                <AnimatedView entering={FadeInDown.delay(100).duration(600)} className="mb-8">
                    ...
                    <Text className="text-gray-600 text-lg">Let&apos;s customize how the AI teaches you</Text>
                </AnimatedView>

                {/* Teaching Style */}
                <AnimatedView entering={FadeInDown.delay(200).duration(600)} className="mb-6">
                    <Text className="text-lg font-semibold text-gray-900 mb-3">Teaching Style</Text>
                    {[
                        {
                            value: 'encouraging' as TeachingStyle,
                            label: 'Encouraging',
                            desc: 'Lots of praise and positive reinforcement',
                        },
                        {
                            value: 'balanced' as TeachingStyle,
                            label: 'Balanced',
                            desc: 'Mix of encouragement and constructive feedback',
                        },
                        {
                            value: 'direct' as TeachingStyle,
                            label: 'Direct',
                            desc: 'Straightforward and efficiency-focused',
                        },
                    ].map((option) => (
                        <TouchableOpacity
                            key={option.value}
                ...
                <AnimatedView entering={FadeInDown.delay(300).duration(600)} className="mb-6">
                    <Text className="text-lg font-semibold text-gray-900 mb-3">Communication Style</Text>
                ...
                <AnimatedView entering={FadeInDown.delay(400).duration(600)} className="mb-6">
                    <Text className="text-lg font-semibold text-gray-900 mb-3">How often should I correct you?</Text>
                    {[
                        {
                            value: 'every_mistake' as CorrectionFrequency,
                            label: 'Every mistake',
                            desc: 'Correct all errors immediately',
                        },
                        {
                            value: 'major_errors' as CorrectionFrequency,
                            label: 'Major errors only',
                            desc: 'Focus on important mistakes',
                        },
                        {
                            value: 'end_of_conversation' as CorrectionFrequency,
                            label: 'End summary',
                            desc: 'Summary at the end',
                        },
                        {
                            value: 'minimal' as CorrectionFrequency,
                            label: 'Minimal',
                            desc: 'Focus on fluency, not accuracy',
                        },
                    ].map((option) => (
                        <TouchableOpacity
                            key={option.value}
                ...
                <AnimatedView entering={FadeInDown.delay(500).duration(600)} className="mb-6">
                    <Text className="text-lg font-semibold text-gray-900 mb-3">Learning Pace</Text>
                    <View className="flex-row gap-3">
                        {[
                ...
                <AnimatedView entering={FadeInDown.delay(600).duration(600)} className="mb-6">
                    <Text className="text-lg font-semibold text-gray-900 mb-3">Daily Practice Goal</Text>
