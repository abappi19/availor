...
export const LevelBadge: React.FC<LevelBadgeProps> = ({ level, currentXP, nextLevelXP, size = 'md' }) => {
    ...
    return (
        <View className="items-center">
            ...
            {/* Progress bar */}
            <View
                className={`${sizes[size].width} mt-3 bg-gray-200 rounded-full overflow-hidden ${sizes[size].progress}`}
            >
