...
import { aiPersonalizationService, AIPersonalization } from '@/services/storage/aiPersonalization';
          ...
          <View className="mt-6">
            ...
            <View className="bg-white">
              ...
              <SettingRow
                icon="speedometer"
                label="Learning Pace"
                value={personalization.learningPace}
              />
              <SettingRow
                icon="list"
                label="Primary Focus"
...
const SettingButton: React.FC<SettingButtonProps> = ({
  ...
  >
    ...
    <View className="flex-1">
      <Text className={`font-medium ${destructive ? 'text-error-600' : 'text-gray-900'}`}>
        {label}
      </Text>
